            ...
            *((u32 *)arr2) = *((u32 *)gMultiplayerCharRings);
            ...
            for (var_r6 = 0; var_r6 < 4; var_r6++) {
                ...
                if (var_r6 != 0) {
                    ...
                    gMultiplayerRanks[arr[0]] = var_r6;
                }
            }

            for (var_r6 = 0; var_r6 < 4; var_r6++) {
                if (gMultiplayerPlayerTasks[var_r6] != NULL) {
                    CreateMultiplayerFinishResult(var_r6, (u8)gMultiplayerRanks[var_r6]);
                }
            }
        } else if (gGameMode == 5) {
                ...
                for (var_r6 = 0; var_r6 < 4; var_r6++) {
                    if (gMultiplayerPlayerTasks[var_r6] != NULL) {
                        if (((gMultiplayerConnections & (0x10 << var_r6)) >> (var_r6 + 4)) == arr[0]) {
                            gMultiplayerRanks[var_r6] = 0;
                        } else {
                            gMultiplayerRanks[var_r6] = 1;
                        }
                    }
                }
            }
            for (var_r6 = 0; var_r6 < 4; var_r6++) {
                if (gMultiplayerPlayerTasks[var_r6] != NULL) {
                    CreateMultiplayerFinishResult(var_r6, gMultiplayerRanks[var_r6]);
                }
            }
        } else if (gGameMode != 6) {
            ...
            if (((u32)gCourseTime > MAX_COURSE_TIME) || ((STAGE_FLAG__TIMER_REVERSED & gStageFlags) && (gCourseTime == 0))) {
                ...
                for (var_r4 = 0; var_r4 < 4 && (gMultiplayerPlayerTasks[var_r4] != NULL); var_r4++) {
                    if ((gMultiplayerRanks[var_r4] == -1) || (gGameMode == 3) || (gGameMode == 5)) {
