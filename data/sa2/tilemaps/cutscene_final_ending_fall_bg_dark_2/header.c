...
const ColorRaw Palette_cutscene_final_ending_fall_bg_dark_2[]
    = INCPAL("data/sa2/tilemaps/cutscene_final_ending_fall_bg_dark_2/palette.pal");
const u8 Tiles_cutscene_final_ending_fall_bg_dark_2[] = INCBIN_U8("data/sa2/tilemaps/cutscene_final_ending_fall_bg_dark_2/tiles.4bpp");
const u16 Tilemap_cutscene_final_ending_fall_bg_dark_2[]
    = INCBIN_U16("data/sa2/tilemaps/cutscene_final_ending_fall_bg_dark_2/tilemap.tilemap2");
