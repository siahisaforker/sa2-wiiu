...
const ColorRaw Palette_cutscene_final_ending_land_flower_field[]
    = INCPAL("data/sa2/tilemaps/cutscene_final_ending_land_flower_field/palette.pal");
const u8 Tiles_cutscene_final_ending_land_flower_field[]
    = INCBIN_U8("data/sa2/tilemaps/cutscene_final_ending_land_flower_field/tiles.4bpp");
const u16 Tilemap_cutscene_final_ending_land_flower_field[]
    = INCBIN_U16("data/sa2/tilemaps/cutscene_final_ending_land_flower_field/tilemap.tilemap2");
