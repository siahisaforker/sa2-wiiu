...
#else
const ColorRaw Palette_sa1_title_logo_jp[] = INCPAL("data/sa2/tilemaps/sa1_title_logo_jp/palette.pal");
#endif

const u8 Tiles_sa1_title_logo_jp[] = INCBIN_U8("data/sa2/tilemaps/sa1_title_logo_jp/tiles.8bpp");
const u16 Tilemap_sa1_title_logo_jp[] = INCBIN_U16("data/sa2/tilemaps/sa1_title_logo_jp/tilemap.tilemap1");
