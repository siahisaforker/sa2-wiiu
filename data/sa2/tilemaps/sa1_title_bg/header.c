...
const ColorRaw Palette_sa1_title_bg[] = {
...
#else
const ColorRaw Palette_sa1_title_bg[] = INCPAL("data/sa2/tilemaps/sa1_title_bg/palette.pal");
#endif

const u8 Tiles_sa1_title_bg[] = INCBIN_U8("data/sa2/tilemaps/sa1_title_bg/tiles.4bpp");
const u16 Tilemap_sa1_title_bg[] = INCBIN_U16("data/sa2/tilemaps/sa1_title_bg/tilemap.tilemap2");
...
const Tilemap sa1_title_bg = {
    ...
    .palOffset = 0,
    .palLength = ARRAY_COUNT(Palette_sa1_title_bg),
