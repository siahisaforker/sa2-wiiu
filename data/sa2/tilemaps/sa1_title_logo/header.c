...
#else
const ColorRaw Palette_sa1_title_logo[] = INCPAL("data/sa2/tilemaps/sa1_title_logo/palette.pal");
#endif

const u8 Tiles_sa1_title_logo[] = INCBIN_U8("data/sa2/tilemaps/sa1_title_logo/tiles.4bpp");
const u8 Tilemap_sa1_title_logo[] = INCBIN_U8("data/sa2/tilemaps/sa1_title_logo/tilemap.tilemap2");
...
const Tilemap sa1_title_logo = {
    ...
    .palOffset = 0,
    .palLength = ARRAY_COUNT(Palette_sa1_title_logo),
