...
const ColorRaw Palette_cutscene_vanilla_kidnapped_full_map_copy[]
    = INCPAL("data/sa2/tilemaps/cutscene_vanilla_kidnapped_full_map_copy/palette.pal");
const u8 Tiles_cutscene_vanilla_kidnapped_full_map_copy[]
    = INCBIN_U8("data/sa2/tilemaps/cutscene_vanilla_kidnapped_full_map_copy/tiles.4bpp");
const u16 Tilemap_cutscene_vanilla_kidnapped_full_map_copy[]
    = INCBIN_U16("data/sa2/tilemaps/cutscene_vanilla_kidnapped_full_map_copy/tilemap.tilemap2");
