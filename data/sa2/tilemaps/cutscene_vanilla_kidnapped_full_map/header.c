...
const ColorRaw Palette_cutscene_vanilla_kidnapped_full_map[] = INCPAL("data/sa2/tilemaps/cutscene_vanilla_kidnapped_full_map/palette.pal");
const u8 Tiles_cutscene_vanilla_kidnapped_full_map[] = INCBIN_U8("data/sa2/tilemaps/cutscene_vanilla_kidnapped_full_map/tiles.4bpp");
const u16 Tilemap_cutscene_vanilla_kidnapped_full_map[]
    = INCBIN_U16("data/sa2/tilemaps/cutscene_vanilla_kidnapped_full_map/tilemap.tilemap2");
