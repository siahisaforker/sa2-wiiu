...
const ColorRaw Palette_storyframe_cream_tails_vanilla_look_around[]
    = INCPAL("data/sa2/tilemaps/storyframe_cream_tails_vanilla_look_around/palette.pal");
const u8 Tiles_storyframe_cream_tails_vanilla_look_around[]
    = INCBIN_U8("data/sa2/tilemaps/storyframe_cream_tails_vanilla_look_around/tiles.4bpp");
const u16 Tilemap_storyframe_cream_tails_vanilla_look_around[]
    = INCBIN_U16("data/sa2/tilemaps/storyframe_cream_tails_vanilla_look_around/tilemap.tilemap2");
