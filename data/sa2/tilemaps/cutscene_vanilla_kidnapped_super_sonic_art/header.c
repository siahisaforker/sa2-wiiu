...
const ColorRaw Palette_cutscene_vanilla_kidnapped_super_sonic_art[]
    = INCPAL("data/sa2/tilemaps/cutscene_vanilla_kidnapped_super_sonic_art/palette.pal");
const u8 Tiles_cutscene_vanilla_kidnapped_super_sonic_art[]
    = INCBIN_U8("data/sa2/tilemaps/cutscene_vanilla_kidnapped_super_sonic_art/tiles.4bpp");
const u16 Tilemap_cutscene_vanilla_kidnapped_super_sonic_art[]
    = INCBIN_U16("data/sa2/tilemaps/cutscene_vanilla_kidnapped_super_sonic_art/tilemap.tilemap2");
