...
const ColorRaw Palette_storyframe_cream_cheese_vanilla_happy[]
    = INCPAL("data/sa2/tilemaps/storyframe_cream_cheese_vanilla_happy/palette.pal");
const u8 Tiles_storyframe_cream_cheese_vanilla_happy[] = INCBIN_U8("data/sa2/tilemaps/storyframe_cream_cheese_vanilla_happy/tiles.4bpp");
const u16 Tilemap_storyframe_cream_cheese_vanilla_happy[]
    = INCBIN_U16("data/sa2/tilemaps/storyframe_cream_cheese_vanilla_happy/tilemap.tilemap2");
