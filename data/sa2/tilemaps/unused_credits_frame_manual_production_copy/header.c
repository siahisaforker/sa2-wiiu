...
const ColorRaw Palette_unused_credits_frame_manual_production_copy[]
    = INCPAL("data/sa2/tilemaps/unused_credits_frame_manual_production_copy/palette.pal");
const u8 Tiles_unused_credits_frame_manual_production_copy[]
    = INCBIN_U8("data/sa2/tilemaps/unused_credits_frame_manual_production_copy/tiles.4bpp");
const u16 Tilemap_unused_credits_frame_manual_production_copy[]
    = INCBIN_U16("data/sa2/tilemaps/unused_credits_frame_manual_production_copy/tilemap.tilemap2");
