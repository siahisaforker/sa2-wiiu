...
const ColorRaw Palette_zone_final_act_unused_fg[] = INCPAL("data/sa2/maps/zone_final/act_unused/tilemaps/fg/palette.pal");
const u8 Tileset_zone_final_act_unused_fg[] = { 0xFF, 0xFF, 0xFF, 0xFF };
const s8 CollHeightMap_zone_final_act_unused_fg[] = INCBIN_U8("data/sa2/maps/zone_final/act_unused/tilemaps/fg/height_map.coll");
const u8 CollTileRot_zone_final_act_unused_fg[] = INCBIN_U8("data/sa2/maps/zone_final/act_unused/tilemaps/fg/tile_rot.coll");
const u16 CollFlags_zone_final_act_unused_fg[] = INCBIN_U16("data/sa2/maps/zone_final/act_unused/tilemaps/fg/flags.coll");
const u16 Metatiles_zone_final_act_unused_fg[] = INCBIN_U16("data/sa2/maps/zone_final/act_unused/tilemaps/fg/metatiles.tilemap2");

const u16 Map_zone_final_act_unused_fg0[] = INCBIN_U16("data/sa2/maps/zone_final/act_unused/tilemaps/fg/map_front.bin");

const u16 Map_zone_final_act_unused_fg1[] = INCBIN_U16("data/sa2/maps/zone_final/act_unused/tilemaps/fg/map_back.bin");
