...
with open("src/data/sa2/tilemap_data.c", "r") as tile_map_data_file:
    tile_map_data_content = "".join(tile_map_data_file.readlines())

for folder in os.listdir("data/sa2/tilemaps"):
    if folder.startswith("zone_"):
        ...
        new_path = f"data/sa2/maps/{zone}/{act}/tilemaps/{layer}"
        tile_maps_path = f"data/sa2/maps/{zone}/{act}/tilemaps/"
        old_path = "data/sa2/tilemaps/" + folder + "/"
...
with open("src/data/sa2/tilemap_data.c", "w") as tile_map_data_file:
