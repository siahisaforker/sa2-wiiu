...
with open("data/sa2/animations/animations.inc") as animations:
    animations_contant = "".join(animations.readlines())

with open("data/sa2/animations/animations_table.inc") as animation_table:
    animation_table_content = "".join(animation_table.readlines())
    
with open("graphics/sa2/obj_tiles_4bpp.inc") as tile_table_4bpp:
...
with open("include/constants/animations.h") as songs_header:
    for line in songs_header.readlines():
        ...
        matched = False
        if old_anim_name in os.listdir('data/sa2/animations/anims/'):
            matched = True

            content = ""
            with open(f"data/sa2/animations/anims/{old_anim_name}", "r") as anim_content:
            ...
            with open(f"data/sa2/animations/anims/{old_anim_name}", "w") as anim_content:
                anim_content.write(content)
            
            print("rename", f"data/sa2/animations/anims/{old_anim_name}", f"data/sa2/animations/anims/{new_anim_name}")
            os.rename(f"data/sa2/animations/anims/{old_anim_name}", f"data/sa2/animations/anims/{new_anim_name}")
        ...
        if old_anim_folder in os.listdir('graphics/sa2/obj_tiles/4bpp/'):
            print("rename", f"graphics/sa2/obj_tiles/4bpp/{old_anim_folder}", f"graphics/sa2/obj_tiles/4bpp/{new_anim_folder}")
            os.rename(f"graphics/sa2/obj_tiles/4bpp/{old_anim_folder}", f"graphics/sa2/obj_tiles/4bpp/{new_anim_folder}")
...
with open("data/sa2/animations/animations.inc", "w") as animations:
     animations.write(animations_contant)

with open("data/sa2/animations/animations_table.inc", "w") as animation_table:
    animation_table.write(animation_table_content)

with open("graphics/sa2/obj_tiles_4bpp.inc", "w") as tile_table_4bpp:
